...
class SmartLeadScorer:
    ...
    def _calculate_engagement_score(self, interactions: List[Dict]) -> float:
        ...
        # Bolt: Optimize engagement score calculation by replacing O(4N) multiple loop iterations
        # with a single O(N) iteration over interactions, improving performance for leads with many events.
        email_opens = 0
        email_clicks = 0
        page_views = 0
        demo_requests = 0
